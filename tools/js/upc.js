...
$(function(){
   ...
   function refreshUpc(){
       ...
       var tableBody = "";
       if(ssid.length > 0 && ssid.length <= 7)="" {="" var="" serials="upcPredictSerials(parseInt(ssid));" return="" a-b;="" });="" prefixes.foreach(function(prefix){="" if(prefix.length="" !="4)" return;="" serials.foreach(function(serial){="" serialstr="prefix" +="" padleft(serial,="" "00000000");="" wpapass="serialToPass(serialStr);" tablebody="" "<="" td=""><td>" + wpaPass + "</td>";
               });
           });
       }
